...
cifar_train_loader = DataLoader.CustomImageDataset(DIR,cifar_transforms_train,train=True,batch_size=batch_size,shuffle=True)

cifar_val_loader = DataLoader.CustomImageDataset(DIR,cifar_transforms_val,train=True,val=True,batch_size=batch_size,shuffle=True)

cifar_test_loader = DataLoader.CustomImageDataset(DIR,cifar_transforms_test,test=True,batch_size=batch_size,shuffle=True)
...
print(summary(custom_model, (3, 32, 32)))